...
import { listQuery, type ListFilter } from "./presentations-core";
import type {
  Detail,
  ExportAnswer,
  FromBrainAnswer,
...
/*
Wrappers over the brain's presentations REST surface
(plugins/brain/internal/brain/presentations_handlers.go +
presentations_domains_handlers.go). Reads need read access to the brain;
every write — including share links and export — needs write access.
*/
