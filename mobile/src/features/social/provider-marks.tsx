...
// Third-party sign-in marks. Google's "G" keeps Google's own colours (its
// branding rules; not ours to theme). GitHub's mark is single-colour and
// follows the text colour. Apple's button is Apple's own native view.
...
export function GitHubMark({ size = 18, color }: { size?: number; color: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 16 16" accessibilityElementsHidden importantForAccessibility="no-hide-descendants">
      <Path
        fill={color}
