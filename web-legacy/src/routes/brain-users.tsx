...
function AgentButton({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-2.5 border-s-2 px-6 py-3 text-start text-sm transition-colors hover:bg-muted ${
  ...
  return (
    <Page>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <Panel className="lg:border-s lg:border-line" label={selected ? <>Actions · <span dir="ltr">{selected}</span></> : "Recent actions"} meta={rows.length}>
          {activity.isLoading ? (
