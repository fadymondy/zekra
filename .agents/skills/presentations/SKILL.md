...
| Tool / endpoint | Use |
|---|---|
| `memory_recall` / `memory_get` / notes | Read the source material from the brain (R1–R3 in `.Codex/rules/memory-first.md`: recall first, cite what you used, never invent) |
