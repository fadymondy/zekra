...
// CaBrain is drawn on the grid (fadymondy.com's design system), which has exactly two themes:
...
// The ThemePicker swatch shows each theme's accent — give it CaBrain's (light violet on the dark
